...
namespace VgcCollege.Data.Migrations
{
    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "LecturerCourseAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LecturerCourseAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LecturerCourseAssignments_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LecturerCourseAssignments_LecturerProfiles_LecturerProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LecturerCourseAssignments_CourseId",
                table: "LecturerCourseAssignments",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_LecturerCourseAssignments_LecturerProfileId",
                table: "LecturerCourseAssignments",
                column: "LecturerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_LecturerProfiles_IdentityUserId",
